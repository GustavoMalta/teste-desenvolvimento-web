...
export default function Form(Data){
  ...
  const [_id]= useState(Data.pokeid);
  ...
  async function SaveEdit(e){
    Data.change({Name,Pokedex_Number,Img_name,Generation,Evolution_Stage,Evolved,FamilyID,Cross_Gen,Type_1,Type_2,Weather_1,Weather_2,STAT_TOTAL,ATK,DEF,STA,Legendary,Aquireable,Spawns,Regional,Raidable,Hatchable,Shiny,Nest,New,Not_Gettable,Future_Evolve,At40,At39})
    e.preventDefault();  
  }
    ...
    <form onSubmit={SaveEdit} className="row"> 
      <div className="card-title px-4 mb-4 col-12 shadow-sm">
          <div className="py-3 d-flex justify-content-between">
            ...
            <span className="btn text-info" onClick={GoBack}>
